...
function cleanPronoun(translated, text, sourceLangName) {
    ...
    // 2. 定義代名詞對應表
    const pronounMap = {
        '我們': ['我們', 'たち', '達', 'ら', '等', '我々', 'われわれ', '共', 'ども', '方', 'がた'],
        '妳們': ['妳們', 'たち', '達', 'ら', '等', '君ら', 'お前ら', '方', 'がた', '皆様'],
        '你們': ['你們', 'たち', '達', 'ら', '等', '君ら', 'お前ら', '方', 'がた', '皆様'],
        '他們': ['彼ら', '彼達', '彼ら等', 'あいつら', '奴ら', 'やつら'],
        '她們': ['彼女ら', '彼女達', 'あいつら'],
        '牠們': ['牠們', 'たち', '達', 'ら', '等', 'それら', 'あれら'],
        '它們': ['它們', 'たち', '達', 'ら', '等', 'それら', 'あれら'],
        '我': ['私', 'わたし', 'わたくし', '僕', 'ぼく', '俺', 'おれ', '自分', 'じぶん', 'あたし', 'うち', '吾輩', '拙者', '余', '朕', '小生'],
        '妳': ['あなた', '貴方', '貴女', '君', 'きみ', 'お前', 'おまえ', 'あんた', '貴様', 'そちら', 'あなた様', 'お宅', '汝', '己', '主'],
        '你': ['あなた', '貴方', '君', 'きみ', 'お前', 'おまえ', 'あんた', '貴様', 'そちら', 'あなた様', 'お宅', '汝', '己', '主'],
        '您': ['あなた', '貴方', '貴女', 'そちら', 'あなた様', '貴殿', '閣下', '皆様', '貴方様方'],
        '他': ['彼', 'かれ', 'あいつ', '奴', 'やつ', 'そいつ', 'こいつ'],
        '她': ['彼女', 'かのじょ', 'あいつ', 'そいつ'],
        '牠': ['牠', 'それ', 'あれ', 'あいつ'],
        '它': ['它', 'それ', 'あれ', 'あいつ']
    };
    ...
    if (cleaned !== original) {
        ...
        cleaned = cleaned.replace(/([，。！？、])(和|跟|與)([，。！？、])/g, '$1');
